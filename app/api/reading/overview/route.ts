...
（三派共同確認的紫微命格結構：直接點出命主命宮的核心星曜格局（格局名稱或主星組合）、最有動能的宮位與最值得關注的一個化忌或煞星落點。約130字。**本段須獨立成文、能脫離上文單獨閱讀**——不得以"三派共同認可""綜上所述""綜合來看"之類承上啟下的字樣開頭，直接論命，因為此段會單獨作為"紫薇綜合"展示給使用者。聚焦命盤的客觀星曜結構，不要重複"性格底色"或"人生主軸"概括——那已在混合解讀中呈現。）
