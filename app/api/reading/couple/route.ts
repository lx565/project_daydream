...
## 飛化互入 · 彼此怎麼互相影響
（約140字：一方的生年四化/重要星曜落入對方命盤的哪個宮，說明彼此牽動的領域——白話講就是「你身上的哪個特質會實際影響到對方生活的哪一塊」。注意命理規則：七殺/天相/天府不參與十干四化；紫微只化權/化科。）
...
繁體中文（臺灣用語）。` + ACCESSIBLE_LANGUAGE_INSTRUCTION + MODERN_INSTRUCTION;
