    ...
    <>
      <JsonLd data={[
        breadcrumbSchema([
          ...
          { name: `${entry.name}在夫妻宮`, path: pagePath },
        ]),
        articleSchema({
      ...
      <main className="min-h-screen bg-parchment">
        <LibraryNav category="hunyin" currentTitle={`${entry.name}在夫妻宮`} />
        ...
        <div className="max-w-2xl mx-auto px-4 pb-16 space-y-6">
          ...
          <ToolCTA variant="card" sub="AI 依據逾百部典籍，結合你的夫妻宮主星與四化，分析你的配偶特質、感情模式與婚姻最佳時機。" label="解析我的婚姻運勢" />
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                {relatedEntries.map(e => (
                  ...
                  >
                    <p className="font-medium">{e.name}在夫妻宮</p>
          ...
          <ToolCTA variant="slim" label="紫微斗數 AI · 依據逾百部典籍為你深度解析夫妻宮與婚姻格局 →" />
